...
-- Add helper files to package.path
package.path = package.path .. ";" .. os.getenv("HOME") .. "/.config/awesome/widgets/?.lua"
package.path = package.path .. ";" .. os.getenv("HOME") .. "/.config/awesome/utils/?.lua"
...
tags = {
    names = {"1:cmd", "2:web", "3:dev", "4:doc", "5:office", "6:misc", "7:misc", "8:im", "9:skype"},
    layouts = {
        layouts[2],  -- cmd, tile
        layouts[2],  -- web, tile
        layouts[2],  -- dev, tile
        layouts[4],  -- doc, fair
        layouts[4],  -- office, fair
        layouts[1],  -- misc, float
        layouts[1],  -- misc, float
        layouts[1],  -- im, float
        layouts[1],  -- skype, float
    }
}
for s = 1, screen.count() do
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "e", function () awful.layout.inc(layouts,  1) end),
    awful.key({ modkey, "Shift"   }, "e", function () awful.layout.inc(layouts, -1) end),
    ...
    -- Volume controll
    awful.key({}, "XF86AudioLowerVolume", function() awful.util.spawn("amixer sset Master,0 10%-") end),
    awful.key({}, "XF86AudioRaiseVolume", function() awful.util.spawn("amixer sset Master,0 10%+") end),
...
awful.rules.rules = {
    ...
    -- [dev] of screen 1.
    { rule_any= { class = { "jetbrains-idea", "jetbrains=studio" } },
